...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String [] id,nama,kategori,lokasi,deskripsi,gambar,website;
    int jumData;
    ...
    private void getlokasi(){
        String url="https://gisdesawisata.000webhostapp.com/desawisata.php";
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        kategori = new  String[jumData];
                        lokasi = new String[jumData];
                        deskripsi = new String[jumData];
                        gambar = new String[jumData];
                        website = new String[jumData];
                                ...
                                for (int i=0;i<jumData;i++){
                                    if (marker.getTitle().equals(nama[i])){
                                        if (MarkerD[i]){
                                            ...
                                            DetailActivity.kategori=kategori[i];
                                            DetailActivity.lokasi=lokasi[i];
                                            DetailActivity.deskripsi=deskripsi[i];
                                            DetailActivity.gambar=gambar[i];
                                            DetailActivity.website=website[i];
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this, "Silahkan klik ikon sekali lagi untuk detail", Toast.LENGTH_LONG);
